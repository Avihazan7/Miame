...
const CORPUS = [
  ...
  { id: "contact", source: "MiaMe/Funnel", body: "יצירת קשר: השארת פרטים בסימולטור ההתאמה באתר, או פנייה ישירה בוואטסאפ. אין סניפים ואין קווי טלפון נוספים — כל פנייה מגיעה לנציג MiaMe." },
