...
begin
  ...
  insert into public.knowledge (id, source, category, body) values
    ...
    ('spyqe-price', 'MiaMe/Spyqe', 'finance',
     'SPYQE בהזמנה מוקדמת: 599 ש"ח ל-18 תשלומים, סה"כ 10,782 ש"ח במקום מחיר יבואן 11,900 ש"ח, ללא ריבית והצמדה. ההטבה ל-248 הנרשמים הראשונים. זהו מחיר SPYQE בלבד ואינו מחיר מיה פור.'),
    ...
    ('spyqe-spec', 'MiaMe/Spyqe', 'models',
     'המפרט הטכני המלא של SPYQE טרם פורסם ואינו מאושר. אין למסור עבורו נתוני מנוע, סוללה, טווח, מהירות, משקל או מידות, וגם לא את הנתונים של מיה פור. התשובה הנכונה היא שהמפרט יפורסם עם אישור היבואן.'),
