...
const FALLBACK: KnowledgeDoc[] = [
  ...
  // ── Pricing ─────────────────────────────────────────────────────────────────
  { id: "price-4x2", source: "MiaMe/Models", text: 'מיה פור 2×4 City (העירוני החכם) — החל מ-19,900 ש"ח.' },
  { id: "price-2x4lr", source: "MiaMe/Models", text: 'מיה פור 2×4 City Long Range (הטווח המורחב) — החל מ-21,900 ש"ח, סוללה 35Ah.' },
  { id: "price-4x4", source: "MiaMe/Models", text: 'מיה פור 4×4 Pro Max (הכוח לכל מסלול) — החל מ-27,900 ש"ח, ארבעה מנועים והנעה כפולה לשטח.' },
  // ── Legal status ────────────────────────────────────────────────────────────
