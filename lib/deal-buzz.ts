...
export const DEAL_BUZZ_CARDS: BuzzItem[] = [
  {
    ...
    text: "נאתר אתכם את הדגם שמתאים לכם, לפי שימוש, טווח ותקציב, ונבנה עליו את פריסת התשלומים.",
    cta: "התחלת בדיקה",
    action: "sim",
  },
  {
  ...
  },
  {
    ...
    text: "נבדוק יחד את גובה המקדמה ומספר התשלומים שמתאימים לכם, עד 18 ללא ריבית והצמדה. בכפוף לאישור עסקה.",
    cta: "בדיקת זכאות",
    action: "wa",
  ...
  },
  {
    ...
    text: "מעדיפים לדבר? נציג אמיתי יחזור אליכם עם כל הפרטים על הדגמים והזמינות.",
