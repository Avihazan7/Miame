...
export const SEO_PAGES: SeoPage[] = [
  {
    ...
    lede: "מיה פור היא קלנועית חשמלית פרימיום על פלטפורמת ארבעה גלגלים מוגנת פטנט, יציבה, נשלטת וחכמה. כאן ריכזנו את כל המידע: הדגמים, הסוללה, הטווח, האחריות ומסלולי התשלום, כדי שתוכלו לבחור נכון ולהתקדם לעסקה מיד.",
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "קלנועית 4 גלגלים מתאימה למגוון רחב: נסיעות יומיומיות בעיר, קניות, הגעה לעבודה, טיולים בשכונה ובטיילת, וגם שימוש עסקי בצי השכרה. דגם 2×4 City העירוני הוא נקודת הכניסה הפופולרית (החל מ-19,900 ₪), ולמי שרוצה טווח גדול יותר מחכה 2×4 City Long Range.",
  ...
  },
  {
    ...
    lede: "החופש האמיתי הוא לקחת את הניידות אתכם. מיה פור מתקפלת ומאפשרת שליפה מהירה של הכיסא, כדי שתוכלו להכניס אותה לרכב, לאחסן בבית או להעמיס לטיול, בלי להתפשר על יציבות של ארבעה גלגלים.",
    hero: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "דגם 2×4 City העירוני הוא הבחירה הטבעית לשימוש הזה: קל, זריז ומתאים לנסיעות קצרות בעיר, החל מ-19,900 ₪. הסוללה (60V) נשלפת בנפרד מהכלי — שולפים אותה, טוענים בבית, ומחזירים."
        ]
      },
      {
