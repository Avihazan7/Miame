    ...
    sections: [
      {
        ...
        body: [
          ...
          "הקלנועית מיועדת למגוון רחב של רוכבים: תושבי עיר שרוצים חלופה חכמה לרכב לנסיעות קצרות, מבוגרים שמחפשים עצמאות ותנועה בטוחה, אנשי עסקים שמפעילים צי השכרה, וגופים שזקוקים לפתרון ניידות בשטח מתוחם. מיה פור משווקת בישראל דרך יבואן רשמי (MEU · Mayer Electric Utilities) עם רשת נקודות שירות ומשווקים מורשים ברחבי הארץ."
        ]
      },
      {
        h: "שלושת הדגמים",
