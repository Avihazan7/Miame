    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "ב-MiaMe בונים את הצעת התשלום שמתאימה לכם: מזינים מקדמה, בלון ומספר תשלומים בסימולטור ומקבלים אומדן תשלום חודשי — ואז שולחים אותו ישירות לנציג בוואטסאפ להמשך טיפול. מסלולי התשלום מוצעים ב-0% ריבית בכפוף לאישור עסקה ולתנאי הספק."
        ]
      }
    ],
    specs: COMMON_SPECS,
