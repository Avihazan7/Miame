...
export const SEO_PAGES: SeoPage[] = [
  {
    ...
    sections: [
      ...
      },
      {
        h: "שלושת הדגמים",
        body: [
          "קו מיה פור כולל שלושה דגמים שנבדלים בעיקר בהנעה ובטווח. דגם X2 הוא העירוני החכם — קל, זריז ומתאים לנסיעות יומיומיות בעיר, החל מ-₪19,900. דגם X2 Long Range מביא סוללה בקיבולת מוגברת (35Ah) לטווח מורחב, למי שעושה קילומטראז' יומי גבוה, החל מ-₪21,900.",
          "דגם X4 הוא הבכיר: ארבעה מנועים והנעה כפולה שנותנים אחיזה וכוח בעליות ובתוואי שטח, החל מ-₪27,900. בכל הדגמים הסוללה נשלפת וניתנת לטעינה בבית או במשרד, כך שאפשר להחזיק סוללה נוספת ולהכפיל בפועל את הטווח היומי. את הבחירה המדויקת אפשר לחדד תוך דקה בסימולטור ההתאמה בעמוד הבית."
        ]
      },
      {
        h: "סוללה, טווח וטעינה",
    ...
    faq: [
      {
        ...
        a: "X2 הוא העירוני הזריז (החל מ-₪19,900), X2 Long Range מציע טווח מורחב עם סוללת 35Ah (החל מ-₪21,900), ו-X4 הוא בעל הנעה כפולה וארבעה מנועים לשטח (החל מ-₪27,900)."
      },
      {
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "קלנועית 4 גלגלים מתאימה למגוון רחב: נסיעות יומיומיות בעיר, קניות, הגעה לעבודה, טיולים בשכונה ובטיילת, וגם שימוש עסקי בצי השכרה. דגם X2 העירוני הוא נקודת הכניסה הפופולרית (החל מ-₪19,900), ולמי שרוצה טווח גדול יותר יש את X2 Long Range.",
    ...
    faq: [
      ...
      },
      {
        ...
        a: "מחיר פתיחה החל מ-₪19,900 לדגם X2 העירוני. אפשר לבנות הצעת תשלום ב-0% ריבית בסימולטור, בכפוף לאישור עסקה ולתנאי הספק."
      }
    ],
    related: [
  ...
  },
  {
    ...
    description:
      "קלנועית מתקפלת עם כיסא בשחרור מהיר שנכנסת לרכב — מיה פור X2 העירונית, סוללה נשלפת 60V, החל מ-₪19,900. בנו הצעת תשלום תוך דקה וקבלו בוואטסאפ.",
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "דגם X2 העירוני הוא הבחירה הטבעית לשימוש הזה: קל, זריז ומתאים לנסיעות קצרות בעיר, החל מ-₪19,900. הסוללה הנשלפת (60V) מתקפלת יחד עם היתר — שולפים אותה, טוענים בבית, ומחזירים."
        ]
      },
      {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "דגם X2 העירוני המתאים לשימוש זה מתחיל מ-₪19,900. אפשר לבנות מסלול תשלום ב-0% ריבית בסימולטור, בכפוף לאישור עסקה ולתנאי הספק."
      }
    ],
    related: [
      { href: "/mia-four", label: "מיה פור — כל הדגמים והמפרט" },
  ...
  },
  {
    ...
    description:
      "קלנועית שטח מיה פור X4: ארבעה מנועים 1,800W, הנעה כפולה, סוללה נשלפת 60V וטווח שימוש עד 100 ק\"מ. החל מ-₪27,900. בנו הצעת תשלום תוך דקה.",
    lede: "כשהדרך נגמרת, מיה פור X4 רק מתחילה. הנעה כפולה וארבעה מנועים נותנים אחיזה וכוח בעליות, בחול ובתוואי לא סלול — בלי לוותר על היציבות של פלטפורמת ארבעת הגלגלים.",
    hero: {
    ...
    sections: [
      {
        ...
        body: [
          "דגם X4 של מיה פור בנוי לתוואי מאתגר. ארבעה מנועים בהספק 1,800W והנעה כפולה מספקים מומנט ואחיזה שמאפשרים להתמודד עם עליות, משטחים חוליים ודרכי עפר. זה הכלי למי שלא מסתפק בעיר — לטיולים בטבע, לשטח חקלאי, לחופים ולכל מקום שדורש יותר מקלנועית עירונית.",
          "החוזק הזה לא בא על חשבון היציבות. הבסיס נשאר פלטפורמת ארבעת הגלגלים המוגנת פטנט, כך שגם בשטח לא אחיד הכלי שומר על תחושת קרקע איתנה. השילוב של אחיזה, כוח ויציבות הוא מה שהופך את X4 לבכיר הקו."
        ]
      },
      {
      ...
      },
      {
        ...
        body: [
          "קלנועית שטח 4×4 מתאימה לחקלאים ולבעלי משקים, לאנשי שטח ותחזוקה, למטיילים שרוצים להגיע רחוק, ולעסקים כמו אתרי תיירות, חופים ומתחמים מתוחמים שזקוקים לכלי אמין. מחיר הפתיחה של X4 הוא החל מ-₪27,900, והוא מגיע עם אחריות יבואן רשמי (MEU).",
          "לא בטוחים אם X4 הוא הדגם עבורכם או שמספיק X2 Long Range? בנו את הצעת התשלום בסימולטור בעמוד הבית, ותאמו נסיעת מבחן כדי להרגיש את הכוח והאחיזה בעצמכם."
        ]
      }
    ],
    specs: [
    ...
    faq: [
      ...
      },
      {
        ...
        a: "דגם X4 מתחיל מ-₪27,900, עם אחריות יבואן רשמי. אפשר לבנות מסלול תשלום ב-0% ריבית בסימולטור, בכפוף לאישור עסקה ולתנאי הספק."
      }
    ],
    related: [
      { href: "/mia-four", label: "מיה פור — כל הדגמים והמפרט" },
