    ...
    sections: [
      {
        ...
        body: [
          "דגם 4×4 Pro Max של מיה פור בנוי לתוואי מאתגר. ארבעה מנועים בהספק 1,800W והנעה כפולה מספקים מומנט ואחיזה שמאפשרים להתמודד עם עליות, משטחים חוליים ודרכי עפר. זה הכלי למי שלא מסתפק בעיר — לטיולים בטבע, לשטח חקלאי, לחופים ולכל מקום שדורש יותר מקלנועית עירונית.",
          "החוזק הזה לא בא על חשבון היציבות. הבסיס נשאר פלטפורמת ארבעת הגלגלים המוגנת פטנט, כך שגם בשטח לא אחיד הכלי שומר על תחושת קרקע איתנה. השילוב של אחיזה, כוח ויציבות הוא מה שהופך את 4×4 Pro Max לבכיר הקו."
        ]
      },
      {
      ...
      },
      {
        ...
        body: [
          "קלנועית שטח 4×4 מתאימה לחקלאים ולבעלי משקים, לאנשי שטח ותחזוקה, למטיילים שרוצים להגיע רחוק, ולעסקים כמו אתרי תיירות, חופים ומתחמים מתוחמים שזקוקים לכלי אמין. מחיר הפתיחה של 4×4 Pro Max הוא החל מ-₪27,900, והוא מגיע עם אחריות יבואן רשמי (MEU).",
