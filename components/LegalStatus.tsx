...
const STATUS = [
  {
    ...
    text: "כל כלי מזוהה במספר שילדה ייחודי עם ת\"ז מלאה מהייצור, בלי רישוי ובלי לוחית.",
  },
  {
      ...
      <div className="wrap">
        <div className="sec-head">
          ...
          <p className="sec-desc">
            ...
            שילדה עם ת"ז כלי מלאה מהייצור, בלי לוחית רישוי, בלי אגרות, ועם פחות חשיפה
            לדוחות שדו-גלגלי ממונע סופג, בכפוף לדין. כל החופש של ניידות אישית, אפס
            הבירוקרטיה של רכב.
          </p>
        </div>
