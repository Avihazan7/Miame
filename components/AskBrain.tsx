...
const FAQ: { keys: string[]; a: string }[] = [
  ...
  { keys: ["מחיר", "עולה", "כמה", "price"], a: "המחירים: MIA FOUR X2 החל מ-19,900 ₪ · X2 Long Range מ-21,900 ₪ · X4 מ-27,900 ₪. אפשר לבנות הצעת תשלום בסימולטור." },
  ...
  { keys: ["משקל", "weight"], a: 'משקל הכלי 42 ק"ג (דגם X2), עומס עד 136 ק"ג.' },
  { keys: ["השכר", "שעה", "rental", "hub"], a: "השכרה החל מ-50 ₪ לשעה דרך רשת MiaMe Hub. רוצים להיות שותף? 13% Success Fee מהפניות בלבד." },
  { keys: ["אילת", "eilat", "green extreme", "גרין אקסטרים", "טרמינל", "השכרה אילת"], a: "באילת: צי השכרה של 15 כלי MIA FOUR ב-Green Extreme (פארק הטרמינל), החל מ-50 ₪ לשעה. משריינים מראש בוואטסאפ. זמינות בזמן אמת תיפתח עם השלמת חיבור המעקב." },
  ...
  { keys: ["אילת", "eilat", "green extreme", "גרין אקסטרים", "טרמינל"], a: "מתוכננת נקודת פעילות של MiaMe באילת סביב Green Extreme בפארק הטרמינל. מחיר אילת ללא מע״מ בכפוף לדין, מקום העסקה, תנאי החברה והפקת חשבונית כדין. רוצה שאבדוק לך מחיר אילת וזמינות בוואטסאפ?" }
];
